  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: usersAsync.when(
        data: (users) {
          final experts = users.where((u) => u.userType == 'Expert').toList();
          final normalUsers = users.where((u) => u.userType == 'User').toList();
                ...
                children: [
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text('All Experts', style: TextStyle(fontSize: 18)),
                        ],
                      ),
                    ],
                  ),
                  ...
                  SizedBox(
                    ...
                    child: DropdownButtonFormField<UserModel>(
                      ...
                      items: experts.map<DropdownMenuItem<UserModel>>((expert) {
                        return DropdownMenuItem<UserModel>(
                          value: expert,
                          child: Text('${expert.firstName} ${expert.lastName}'),
                        );
                      }).toList(),
                      onChanged: sendToAllUsers || sendToAllExperts
                          ? null
